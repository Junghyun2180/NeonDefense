...
const WaveInfoBar = ({
    ...
    const z = {
        ...
        gap:          compact ? 8 : 14,
        eyebrowSize:  compact ? 8 : 10,
        eyebrowSpace: compact ? 1.2 : 2,
        stageSize:    compact ? 11 : 14,
        groupGap:     compact ? 6 : 8,
        groupPadL:    compact ? 8 : 14,
        chipPadding:  compact ? '2px 6px 2px 4px' : '4px 10px 4px 6px',
        chipGap:      compact ? 4 : 6,
        imgSize:      compact ? 22 : 36,
        countSize:    compact ? 12 : 16,
        tagPadding:   compact ? '2px 5px' : '3px 8px',
        tagSize:      compact ? 8 : 9,
        themeSize:    compact ? 9 : 9,
        autoPadding:  compact ? '3px 6px' : '5px 10px',
        autoSize:     compact ? 9 : 10,
        autoBoxSize:  compact ? 10 : 11,
    };
